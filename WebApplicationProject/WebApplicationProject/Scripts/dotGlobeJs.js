...
function jsGlobe() {
    ...
    // Cache DOM selectors
    var htmlCollection = document.getElementsByClassName('js-globe');
    ...
    var props = {
        ...
        colours: {
            // Cache the colours
            globeDots: 'rgb(151, 109, 147)', // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
...
document.addEventListener("DOMContentLoaded", jsGlobe);